...
export default {
  ...
  methods: {
    change_src0(lat,lon){
      this.$refs.baiduMap.geoCoordMap.台风中心1[0]=lat
      this.$refs.baiduMap.geoCoordMap.台风中心1[1]=lon
      this.$refs.baiduMap.my_mounted()
     console.log( this.$refs.baiduMap.geoCoordMap)
    },
    change_src1(lat,lon){
      this.$refs.baiduMap.geoCoordMap.台风中心2[0]=lat
      this.$refs.baiduMap.geoCoordMap.台风中心2[1]=lon
      this.$refs.baiduMap.my_mounted()
      console.log( this.$refs.baiduMap.geoCoordMap)
    },
